...
void _transactionSerialize(
  ...
  writer.writeString(offsets[2], object.attachmentLocalPath);
  writer.writeLong(offsets[3], object.categoryID);
  writer.writeDateTime(offsets[4], object.createdAt);
  writer.writeLong(offsets[5], object.id);
  writer.writeLong(offsets[6], object.needToSync);
...
Transaction _transactionDeserialize(
  ...
  final object = Transaction(
    ...
    attachmentLocalPath: reader.readStringOrNull(offsets[2]),
    ...
    needToSync: reader.readLongOrNull(offsets[6]),
...
void _transactionAttach(
  ...
  object.localId = id;
  object.category
      .attach(col, col.isar.collection<TrxCategory>(), r'category', id);
}

extension TransactionQueryWhereSort
    on QueryBuilder<Transaction, Transaction, QWhere> {
  QueryBuilder<Transaction, Transaction, QAfterWhere> anyLocalId() {
...
extension TransactionQueryWhere
  ...
  QueryBuilder<Transaction, Transaction, QAfterWhereClause> localIdGreaterThan(
      Id localId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Transaction, Transaction, QAfterWhereClause> localIdLessThan(
      Id localId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<Transaction, Transaction, QAfterWhereClause> localIdBetween(
    Id lowerLocalId,
    Id upperLocalId, {
...
extension TransactionQueryFilter
  ...
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition> userIdIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'userId',
      ));
...
extension TransactionQuerySortBy
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByAttachment() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'attachment', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByAttachmentDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByNeedToSync() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'needToSync', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByNeedToSyncDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionQuerySortThenBy
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByAttachment() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'attachment', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByAttachmentDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'attachment', Sort.desc);
    });
  }
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByNeedToSync() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'needToSync', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByNeedToSyncDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'needToSync', Sort.desc);
    });
  }
...
extension TransactionQueryWhereDistinct
  ...
  QueryBuilder<Transaction, Transaction, QDistinct> distinctByAttachment(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Transaction, Transaction, QDistinct> distinctByNeedToSync() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionQueryProperty
  ...
  QueryBuilder<Transaction, int, QQueryOperations> localIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Transaction, String?, QQueryOperations> attachmentProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Transaction, int?, QQueryOperations> needToSyncProperty() {
    return QueryBuilder.apply(this, (query) {
